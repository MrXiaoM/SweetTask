...
public class TaskConsume implements ITask {
    public static final String TYPE = "consume";
    @Override
    public String type() {
        return TYPE;
    }
    ...
    public TaskConsume(List<ItemMatcher> items, int target, String actionTips) {
