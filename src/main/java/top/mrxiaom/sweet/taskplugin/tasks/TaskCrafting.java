...
public class TaskCrafting implements ITask {
    ...
    public static void register() {
        ITask.registerParser("crafting", (args, actionTips, warn) -> {
            ...
            return new TaskCrafting(items, target, actionTips);
        });
    }
    ...
    public TaskCrafting(List<ItemMatcher> items, int target, String actionTips) {
