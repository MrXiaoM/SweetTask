...
public class TaskBreed implements ITask {
    public static final String TYPE = "breed";
    @Override
    public String type() {
        return TYPE;
    }
    public static void register() {
        ITask.registerParser(TYPE, (args, actionTips, warn) -> {
            ...
            return new TaskBreed(entities, target, actionTips);
        });
    }
    ...
    public TaskBreed(List<EntityMatcher> entities, int target, String actionTips) {
