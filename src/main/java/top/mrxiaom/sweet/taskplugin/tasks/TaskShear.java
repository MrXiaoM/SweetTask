...
public class TaskShear implements ITask {
    ...
    public static void register() {
        ITask.registerParser(TYPE, (args, actionTips, warn) -> {
            ...
            return new TaskShear(entities, target, actionTips);
        });
    }
    ...
    public TaskShear(List<EntityMatcher> entities, int target, String actionTips) {
